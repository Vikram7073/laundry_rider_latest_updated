...
import 'package:laundry_rider/common/custom_widget/custom_textfield.dart';
        ...
        body: BlocConsumer<BookingPageBloc,BookingPageState>(
          ...
          builder: (context,state){
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text("Booking Type",style: AppStyles.backGround14Text,),
                              Text(booking?.proccess.toString()=="F2U"?"Pickup":"Delivery",style: AppStyles.backGround14Text.copyWith(fontWeight: FontWeight.bold)),
                            ],
                          ),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          ...
                          SizedBox(height: 5.h,),
                          booking?.proccess.toString()=="F2U"?  Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Container(
            ...
            ListView.builder(
                ...
                shrinkWrap: true,
                itemBuilder: (context,index){
                  bookingPageModel?.data.accept.forEach((element) {
                    pinController.add(TextEditingController(text: ""));
                  });
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(booking?.userName??"",style: AppStyles.backGround14Text,),
                              InkWell(
                                onTap: () async {
                                  await launchUrl(Uri.parse("tel:${booking?.contact}"));
                                },
                                child: Card(
                                    elevation: 2,
                                    child: Row(
                                      children: [
                                        SizedBox(width: 5.w,),
                                        Icon(Icons.call_sharp,size: 20.sp),
                                        SizedBox(width: 5.w,),
                                        Text("Call ",style: AppStyles.backGround14Text,),
                                        SizedBox(width: 5.w,),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("Pin Verification",style: AppStyles.backGround14Text,),
                              SizedBox(
                                height: 30.h,
                                width: 70.w,
                                child: CustomField(
                            ...
                            children: [
                              ...
                              SizedBox(
                                  ...
                                  child: Text(booking?.address??"",
                                    textAlign: TextAlign.right,style: AppStyles.backGround14Text,)),
                            ],
                          ),
                          SizedBox(height: 5.h,),
                        ],
